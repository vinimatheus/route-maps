...
interface AddressPanelProps {
  originCep: string
  setOriginCep: (cep: string) => void
  origin: RouteAddress | null
  originError: string | null
  isLoadingOrigin: boolean
  handleAddOrigin: () => Promise<void>
  addressCep: string
  ...
  calculateRoute: (forceReturn?: boolean) => Promise<void>
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    className={cn(
                      ...
                      originError ? "border-destructive ring-destructive/20 ring-2" : "",
                    )}
                    value={originCep}
                    onChange={(e) => {
              ...
              <div className="space-y-2">
                <div className="flex gap-2">
                  <Input
                    ...
                    className={cn(
                      "transition-all duration-200",
                      addressError ? "border-destructive ring-destructive/20 ring-2" : "",
                    )}
                    value={addressCep}
                    onChange={(e) => {
                              ...
                              {(provided, snapshot) => (
                                <li
                                  ...
                                  className={cn(
                                    ...
                                    snapshot.isDragging ? "bg-primary/10 border-primary/30 shadow-lg scale-[1.02] rotate-1" : "hover:bg-primary/5 hover:border-primary/20 hover:shadow-md"
                                  )}
                                >
                                  <div className="flex items-center gap-2 overflow-hidden">
                                    ...
                                    <span className="text-sm truncate">{address.description}</span>
                                  </div>
                                  <TooltipProvider>
                                    <Tooltip>
